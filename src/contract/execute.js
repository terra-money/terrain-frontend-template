import { LCDClient, MsgExecuteContract, StdFee } from '@terra-money/terra.js'
...
const _exec =
  (msg, fee = new StdFee(200000, { uluna: 10000 })) =>
  async (wallet) => {
    ...
    const { result } = await wallet.post({
      fee,
      msgs: [new MsgExecuteContract(wallet.walletAddress, contractAdress(wallet), msg)],
    })
